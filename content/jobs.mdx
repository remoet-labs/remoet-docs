---
title: GET /user/jobs
description: Returns your work history — every job you've added to your remoet.dev profile, sorted by current first then start-date descending.
---
...
- type: `REST`
- method: `GET`
- url: https://api.remoet.dev/user/jobs
- returns: `JSON`
...
fetch("https://api.remoet.dev/user/jobs", requestOptions)
...
- <Link href="/full">`/user/full`</Link> — same jobs plus the rest of your profile
